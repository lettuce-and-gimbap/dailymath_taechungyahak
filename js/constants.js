...
/* ===== 기출 출처 매핑 (2021~2026년) ===== */
var HIGH_Q_SOURCE={
  '다항식 사칙연산':'Q1번','항등식':'Q2번','나머지 정리':'Q3번','나누어떨어지는 조건':'Q3번','조립제법':'Q3번',
  '인수분해':'Q4번','복소수':'Q5번','켤레복소수':'Q5번','이차방정식 중근':'Q5~6번','이차방정식 근과 계수':'Q6번',
  '두 근→이차방정식':'Q6~7번','이차함수 최댓/최솟값':'Q7번','삼차방정식 한 근':'Q8번','사차방정식 한 근':'Q8번',
  '연립방정식':'Q9번','연립부등식':'Q9번','이차부등식':'Q10번','절댓값 부등식':'Q10번',
  '두 점 거리':'Q11번','내분점(수직선)':'Q11번','내분점(좌표평면)':'Q11번','직선과 원':'Q11~13번','원점→직선 거리':'Q11~12번',
  '직선 방정식':'Q12번','평행 직선':'Q12번','수직 직선':'Q12번',
  '원의 방정식':'Q13번','원의 방정식(지름)':'Q13번','원의 대칭이동':'Q13번',
  '평행이동':'Q14번','대칭이동':'Q14번',
  '집합 원소연산':'Q15번','집합 개수':'Q15번','합집합+교집합 개수':'Q15번','집합 상수 구하기':'Q15번',
  '진리집합':'Q16번','명제의 역':'Q16번','명제의 이':'Q16번','명제의 대우':'Q16번',
  '충분조건':'Q16번','필요충분조건':'Q16번',
  '합성함수':'Q17번','역함수':'Q17번','역함수(공식)':'Q17번',
  '유리함수 점근선':'Q18번','유리함수 평행이동':'Q18번','무리함수 평행이동':'Q18번','무리함수 상수':'Q18번',
  '순열':'Q19번','조합':'Q20번',
};
var MID_Q_SOURCE={
  '소인수분해':'Q1~4번 (수와 연산)','수의 대소':'Q1~4번 (수와 연산)','순환소수':'Q1~4번 (수와 연산)','지수법칙':'Q1~4번 (수와 연산)',
  '식의 값':'Q5~12번 (문자와 식)','문자를 사용한 식':'Q5~12번 (문자와 식)',
  '일차방정식':'Q5~12번 (문자와 식)','연립방정식':'Q5~12번 (문자와 식)','일차부등식':'Q5~12번 (문자와 식)',
  '근호의 계산':'Q5~12번 (문자와 식)','이차방정식':'Q5~12번 (문자와 식)',
  '일차함수':'Q13~15번 (함수)','일차함수 y절편':'Q13~15번 (함수)','이차함수 그래프':'Q13~15번 (함수)',
  '이등변삼각형':'Q16~20번 (기하)','닮음':'Q16~20번 (기하)','삼각비':'Q16~20번 (기하)',
  '원주각과 중심각':'Q16~20번 (기하)','같은 호의 원주각':'Q16~20번 (기하)',
  '확률':'Q21~25번 (확률과 통계)','경우의 수':'Q21~25번 (확률과 통계)',
  '평균':'Q21~25번 (확률과 통계)','중앙값':'Q21~25번 (확률과 통계)','최빈값':'Q21~25번 (확률과 통계)','도수분포표':'Q21~25번 (확률과 통계)',
};
var getExamSource=function(q){
  if(q.category!=='exam5')return null;
  var isMid=q.meta?.level==='middle'||q.meta?.diff==='중졸';
  var map=isMid?MID_Q_SOURCE:HIGH_Q_SOURCE;
  var qNum=map[q.topic];
  if(!qNum)return null;
  return(isMid?'중졸':'고졸')+' 기출 '+qNum+' 유형 (2021~2026년)';
};
